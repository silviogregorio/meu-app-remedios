                ...
                <div className="space-y-4">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="w-full px-4 py-3 text-left rounded-xl border border-slate-400 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-white flex items-center justify-between hover:border-slate-500 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-200"
                        >
                            <span>
